...
Add one car, one bike, and one van.
Register two customers.
Display available vehicles.
Customer A reserves the car for three days.
Customer B attempts to reserve the same car and receives an unavailable message.
Customer A pays successfully.
Customer A returns the car one day late.
Base amount = Rs. 6,000.
Late fee = 1 × 20% × Rs. 2,000 = Rs. 400.
Final amount = Rs. 6,400.
Final invoice is displayed.
The returned car becomes available again.
Customer A's rental history is displayed.
